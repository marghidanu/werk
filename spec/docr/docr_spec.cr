...
describe Docr do
  describe ".parse_repository_tag" do
    it "should default to latest tag" do
      repo, tag = Docr.parse_repository_tag("alpine")
    ...
    it "should parse explicit tag" do
      repo, tag = Docr.parse_repository_tag("alpine:3.18")
    ...
    it "should parse namespaced image" do
      repo, tag = Docr.parse_repository_tag("my/repo:v1.0")
    ...
    it "should handle registry with port" do
      repo, tag = Docr.parse_repository_tag("registry:5000/image:tag")
    ...
    it "should handle registry with port and no tag" do
      repo, tag = Docr.parse_repository_tag("registry:5000/image")
